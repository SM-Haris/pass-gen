...
type DecryptFormData = z.infer<typeof encryptionSchema>;

const DecryptForm: React.FC<{ formAction: any }> = ({ formAction }) => {
  ...
  const onSubmit: SubmitHandler<DecryptFormData> = async (data) => {
    await execute(data);
  };
  ...
  return (
    <FormWrapper onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="flex justify-center">
        <SubmitButton isLoading={isSubmitting || isPending} text="Decrypt" />
      </div>
